...
const NYTData = ({ data }) => {
 ...
 const [readLaterItems, setReadLaterItems] = useState('');
  ...
  const handleLoadMore = () => {
    navigate("/all_newyork_times_news", { state: { remainingItems: data.slice(7) } });
  };
  ...
  return (
    <Container>
      <h2 className="mt-4 mb-4 text-light">News Coverage: Key Global Stories</h2>
